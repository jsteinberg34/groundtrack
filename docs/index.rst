...
The library was developed at Johns Hopkins University in collaboration with Dr. Benjamin Fernando (Los Alamos National Laboratory) and was validated against the `Shenzhou-15 re-entry event <https://doi.org/10.1126/science.adz4676>`_, reproducing published results from a peer-reviewed *Science* paper.
